...
#
# Inputs:
# begin_range: First n in the sequence range
# end_range: Last n in the sequence range
# a: Value for a in equation
# b: Value for b in equation
# c: Value for c in equation
# check_for_multiple: Check if calculated product is a multiple of this
##########